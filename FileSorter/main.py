...
def main():
    user_path: str = input('Please provide a path for us to organise: ')

    if os.path.exists(path=user_path):
        sort_files(user_path)
        remove_empty_folders(user_path)
